...
Насос може штатно працювати без жодного відкритого клапана: на ділянці є водяні
розетки для шланга. Режим обирається в `input_select.poliv_ruchna_zona`
варіантом `Без клапана (шланг)` — тоді ручний пуск не відкриває зону, а сторож
«насос без клапана» не втручається; ліміт три години лишається. Не додавайте
логіку, яка вважає роботу насоса без клапана аварією саму по собі: подробиці —
у `.claude/skills/home-assistant/references/irrigation.md`.
